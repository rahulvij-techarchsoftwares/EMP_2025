...
export const Clients = () => {
    ...
    return (
      <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm p-6 mb-3.5">
        ...
        <button onClick={() => setShowPopup(true)} className="mt-4 px-4 py-2 bg-blue-500 text-white rounded-md">Add Client</button>

        {showPopup && (
                <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                        <h3 className="text-lg font-semibold">Select Hiring Method</h3>
                        ...
                        <button onClick={() => setShowPopup(false)} className="mt-4 text-red-500">Close</button>
                    </div>
                </div>
            )}
