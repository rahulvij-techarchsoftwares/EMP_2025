          ...
          {tasks.data?.tasks.length > 0 ? (
            tasks.data.tasks.map((task) => (
              <div key={task.id} className="relative px-5 py-1 border-b border-[#e1e1e1] pb-5">
                <div className="absolute w-5 h-5 bg-[black] rounded-full -left-[0.7rem] top-3"></div>
                    ...
                    {editTaskId === task.id ? (
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex items-center px-3 py-2 bg-green-500 text-white rounded-lg shadow-md hover:bg-green-600"
                        ><Save className="h-4 w-4 mr-1" />
                          Save
                        </button>
                        <button
                          onClick={cancelEdit}
                          className="px-3 py-2 bg-red-500 text-white rounded-lg shadow-md hover:bg-red-600"
                        >
                          Cancel
                        </button>
                      </div>
                      ...
                      <button
                        ...
                        className="flex justify-between text-base items-center px-3 py-1.5 bg-amber-500 hover:bg-amber-600 text-white rounded-md transition"
