  ...
  return (
    <>
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <button 
          type="submit" 
          className="flex mt-5 mx-auto py-3 px-6 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform transition-all duration-200 ease-in-out hover:shadow-lg hover:-translate-y-0.5"
        >
      ...
      <div className="overflow-x-auto rounded shadow-lg">
        ...
        <table className="min-w-full bg-white">
          <thead>
            <tr className="bg-black border-b border-blue-100">
