    ...
    <>
      <div>
        <div className=" min-h-screen space-x-2 min-w-full overflow-hidden">
          {/* Date Section */}
          <div className="flex items-start justify-between mt-0 mx-[8px] mb-[10px]">
          ...
          <div className="min-w-screen ml-0 lg:mb-32 rounded">
            <div className="overflow-x-auto">
              ...
              {savedEntries.length > 0 && (
                <div className="mt-4 bg-white rounded-xl shadow-lg p-6 animate-fadeIn border border-[#d3d3d3]">
